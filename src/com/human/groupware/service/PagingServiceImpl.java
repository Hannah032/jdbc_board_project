...
public class PagingServiceImpl implements PagingService {
	/**
	 *  * 
     * @param totalCount 전체 데이터 개수 (데이터베이스에서 조회된 총 레코드 수)
     * @param countList  페이지당 표시할 항목 수 (한 페이지에 보여줄 게시글 개수)
     * @param pageNum    현재 페이지 번호 (사용자가 요청한 페이지)
     * @return Paging    계산이 완료된 페이징 객체
	 */
	@Override
