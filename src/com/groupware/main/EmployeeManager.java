...
public class EmployeeManager {
	...
	public static void employeeMenu() {
		...
		System.out.println((getCurrentEmployee()==null)?" ":(getCurrentEmployee().getName()+"님 연결중입니다."));
	...
	public static void register() {
		...
		employee.setHireDate(new Date()); // 입사일은 현재 날짜로 자동 설정
	...
	public static void login() {
		...
		if (employee != null) {
			...
			System.out.println("로그인 성공! " + employee.getUserId() + "님 환영합니다.");
		} else {
