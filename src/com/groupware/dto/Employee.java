...
public class Employee {
    ...
    /**
     * 신규 직원 등록 시 주로 사용하는 생성자 (이름, 부서, 직급)
     * @param name
     * @param department
     * @param bposition
     */
    public Employee(String name, String department, String bposition) {
        this.name = name;
    ...
    /**
     * 신규 직원 등록 시 주로 사용하는 생성자 (이름, 부서, 직급, 입사일자)
     * @param name
     * @param department
     * @param bposition
     * @param hireDate
     */
    public Employee(String name, String department, String bposition, Date hireDate) {
        this.name = name;
        this.department = department;
        this.bposition = bposition;
